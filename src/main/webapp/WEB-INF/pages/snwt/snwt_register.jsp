    ...
    <form action="/snwt/user/register.do" method="post">
        <table class="table_menu">
            <tr>
                ...
                <td>
                    <input class="input_text" id="iIptYear" type="text" name="year" />
                </td>
            </tr>
            <tr>
                <td class="td_title">
                ...
                <td>
                    <input class="input_text" id="iIptName" type="text" name="name" username_status="" onblur="checkUserName()" />
                </td>
            </tr>
            <tr>
                <td class="td_title">
                ...
                <td>
                    <input class="input_text" id="iIptMobilePhone" type="text" name="mobilePhone" />
                </td>
            </tr>
            <tr>
                <td class="td_title">
            ...
            <tr>
                <td colspan="2" style="padding-top:15px;">
                    ...
                    <a href="#" style="font-size:18px;" class="button green" onclick="register()" style="width:130px;">注册</a>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div id="iDiv_errorMsg">${errorMsg}</div>
                </td>
            </tr>
        </table>
    </form>
