...
<body>
    <div class="cDiv_container">
        <div>
            ...
            <input type="hidden" id="iIpt_beGroupMember_h" value="${beGroupMember}" />
        ...
        <div class="cDiv_systemInfo">
            ...
            <c:if test="${userName != ''}">
                <span class="cSpan_loginInfo">当前登录用户：${userName}
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                    当前群组：${groupName}&nbsp;(&nbsp;${groupMemberNum}&nbsp;)&nbsp;&nbsp;</span>
            </c:if>
            <a href="javascript:;" class="grayButton" onclick="backToMyStockPage()">返回我的持股页面</a>
            <a href="javascript:;" class="grayButton" onclick="refreshGroupDataPage()">手动刷新群组页面</a>
        </div>
