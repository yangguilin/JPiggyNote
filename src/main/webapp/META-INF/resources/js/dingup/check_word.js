...
var eventHandler = {
    ...
    searchWord: function(obj){
        ...
        if (word != null && word != ""){
            window.location.href = "/dingup/check_word?search_word=" + word;
        }
    },
    showLatestUpdateWord: function(){
        window.location.href = "/dingup/check_word?latest_update_index=1";
    },
    reloadCurrentPage: function(){
        window.location.href = "/dingup/check_word";
    }
};
